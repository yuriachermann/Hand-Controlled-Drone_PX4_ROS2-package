...
* Hardware
  ...
  * [Holybro Pixhawk 6X](https://leap2.ultraleap.com/products/leap-motion-controller-2/) \*
  * Power Module \*
  * Drone Frame \*
  * Motors + ESCs \*
...
First of all make sure to use a Linux system, specially an [Ubuntu 22.04](https://ubuntu.com/download/alternative-downloads) to avoid possible divergences. Once in the system, upgrade all packages and if the upgrade process installs a new kernel or makes significant changes, it's a good idea to reboot your system:
...
To install Python 3.10.x run this command on a terminal:

``` bash
sudo apt install software-properties-common -y
sudo add-apt-repository ppa:deadsnakes/ppa
sudo apt update
sudo apt install python3.10 python3.10-venv python3.10-dev && python3 --version
```
...
To clone and [install PX4](https://docs.px4.io/main/en/dev_setup/dev_env_linux_ubuntu.html#simulation-and-nuttx-pixhawk-targets) run this script in a bash shell:
...
As mentioned in the [PX4 Docs](https://docs.px4.io/main/en/ros/ros2_comm.html#setup-micro-xrce-dds-agent-client) run this script in order to build Micro XRCE-DDS on your machine:
